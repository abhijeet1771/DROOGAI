...
## 🚀 Automatic PR Review & Index Updates
...
- ✅ Uploads review report
- ✅ Adds PR summary comment
...
**Features:**
- ✅ Automatic index update on merge
- ✅ Commits index file to repo
- ✅ Available for all PRs
...
**PR Review:**
1. Go to **Actions** → **Droog AI Code Review**
2. Click **Run workflow**
3. Enter PR number
4. Click **Run workflow**

**Index Update:**
1. Go to **Actions** → **Droog AI Index Update**
2. Click **Run workflow**
...
- ✅ Code is checked out fresh each time
...
1. ✅ Setup workflows (`droog setup-github`)
2. ✅ Add secrets (GEMINI_API_KEY)
3. ✅ Test with a PR
4. ✅ Monitor first few reviews
