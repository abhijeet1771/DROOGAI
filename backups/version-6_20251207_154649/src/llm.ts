...
Analyze this diff and return JSON array of issues.`;
    ...
    try {
      ...
      if (isDailyQuota) {
        ...
        console.error(`   2. Upgrade to paid tier: https://ai.google.dev/pricing`);
        console.error(`   3. Use a different Gemini API key (if available)`);
        console.error(`   4. Reduce PR size or review fewer files at once`);
